...
class Database:
    def __init__(self, master, row, column, sticky, padx, pady, width, height):
        ...
        self.hostnameLabel = ctk.CTkLabel(master=self.databaseBoxFrame, font=self.font, text="Hostname", text_color="#000000")
        self.hostnameLabel.grid(row=0, column=1, sticky='w', padx=self.paddingX, pady=self.paddingY)
        ...
        self.usernameLabel = ctk.CTkLabel(master=self.databaseBoxFrame, font=self.font, text="Username", text_color="#000000")
        self.usernameLabel.grid(row=1, column=1, sticky='w', padx=self.paddingX, pady=self.paddingY)
        ...
        self.passwordLabel = ctk.CTkLabel(master=self.databaseBoxFrame, font=self.font, text="Password", text_color="#000000")
        self.passwordLabel.grid(row=2, column=1, sticky='w', padx=self.paddingX, pady=self.paddingY)
        ...
        self.databaseLabel = ctk.CTkLabel(master=self.databaseBoxFrame, font=self.font, text="Database", text_color="#000000")
        self.databaseLabel.grid(row=3, column=1, sticky='w', padx=self.paddingX, pady=self.paddingY)
        ...
        self.portLabel = ctk.CTkLabel(master=self.databaseBoxFrame, font=self.font, text="Port", text_color="#000000")
