...
class PhotoStorage:
    def __init__(self, master, row, column, sticky, padx, pady, width, height):
        ...
        self.frameHeight = int(height * .129)
        ...
        self.photoStorageBoxFrame = ctk.CTkFrame(master=self.photoStorageFrame, fg_color="#FFFFFF", width=self.frameWidth, height=self.frameHeight)    
