...
class SearchGUI:
    def __init__(self, master, row, column, sticky, padx, pady, width, height, ipadx=0, ipady=0):
        ...
        self.userNoEntry = ctk.CTkEntry(master=self.searchGUIFrame, width=int(.5 * self.frameWidth), fg_color="#AEB9F1", border_width=0, corner_radius=5, height=int(self.frameHeight * .226), font=ctk.CTkFont(size=int(self.frameWidth * .035), family="Inter"))
        ...
        self.surnameEntry = ctk.CTkEntry(master=self.searchGUIFrame, width=int(.5 * self.frameWidth), fg_color="#AEB9F1", border_width=0, corner_radius=5, height=int(self.frameHeight * .226), font=ctk.CTkFont(size=int(self.frameWidth * .035), family="Inter"))
        ...
        self.firstNameEntry = ctk.CTkEntry(master=self.searchGUIFrame, width=int(.5 * self.frameWidth), fg_color="#AEB9F1", border_width=0, corner_radius=5, height=int(self.frameHeight * .226), font=ctk.CTkFont(size=int(self.frameWidth * .035), family="Inter"))
