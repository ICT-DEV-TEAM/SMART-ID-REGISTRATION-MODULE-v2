...
class PersonalInformation():
    def __init__(self, master, row, column, sticky, padx, pady, width, height, ipadx=0, ipady=0):
        ...
        self.birthDateLabel = ctk.CTkLabel(master=self.emergencyGUI, font=self.font, text="Birthdate*", text_color=self.color.black)
        self.birthDateLabel.grid(row=1, column=3, sticky='ws', padx=self.paddingX, pady=self.paddingY)

        self.birthPlaceLabel = ctk.CTkLabel(master=self.emergencyGUI, font=self.font, text="Birth place*", text_color=self.color.black)
        ...
        self.ageLabel = ctk.CTkLabel(master=self.emergencyGUI, font=self.font, text="Age*", text_color=self.color.black)
        self.ageLabel.grid(row=1, column=5, sticky='wn', padx=self.paddingX, pady=self.paddingY)

        self.mobileNoLabel = ctk.CTkLabel(master=self.emergencyGUI, font=self.font, text="Mobile Number", text_color=self.color.black)
        self.mobileNoLabel.grid(row=2, column=5, sticky='wn', padx=self.paddingX, pady=self.paddingY)
        
        self.emailLabel = ctk.CTkLabel(master=self.emergencyGUI, font=self.font, text="Email", text_color=self.color.black)
